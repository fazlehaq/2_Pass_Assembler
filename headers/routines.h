...
int handle_op_label(int pass,SymbolTable *symbol_table,FILE *lst_file,int address,char* op_name, char* label_name);
...
int handle_dword_reg_addr_to_immd(int pass,FILE * lst_file,char *opc,char *reg1,int value);
